            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                @can('lihat report')
                    <li class="nav-item dropdown {{request()->is('report*') ? 'active' : ''}}">
                        ...
                        <div class="dropdown-menu {{request()->is('report*') ? 'show' : ''}}">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item {{Route::is('report.purchase') ? 'active' : ''}}" href="{{route('report.purchase')}}">
                                        Purchase
                                    </a>
                                    <a class="dropdown-item {{Route::is('report.retur') ? 'active' : ''}}" href="{{route('report.retur')}}">
                                        Return
                                    </a>
                                    <a class="dropdown-item {{Route::is('report.sale') ? 'active' : ''}}" href="{{route('report.sale')}}">
                                        Sale
                                    </a>
                                </div>
                            </div>
