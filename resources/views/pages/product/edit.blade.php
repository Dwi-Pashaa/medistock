            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="code" value="{{$product->code}}" id="code" class="form-control @error('code') is-invalid @enderror">
                        @error('code')
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="harga_beli" value="{{$product->harga_beli}}" id="harga_beli" class="form-control @error('harga_beli') is-invalid @enderror">
                        @error('harga_beli')
                            <span class="invalid-feedback">
                                {{$message}}
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="harga_jual" value="{{$product->harga_jual}}" id="harga_jual" class="form-control @error('harga_jual') is-invalid @enderror">
                        @error('harga_jual')
                            <span class="invalid-feedback">
                                {{$message}}
                            </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="kategori_id" id="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                            ...
                            @foreach ($kategori as $ktg)
                                <option value="{{$ktg->id}}" {{$product->kategori_id == $ktg->id ? 'selected' : ''}}>{{$ktg->name}}</option>
                            @endforeach
                        </select>
                        @error('kategori_id')
                            <span class="invalid-feedback">
